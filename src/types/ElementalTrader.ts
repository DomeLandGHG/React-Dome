...
export const TRADER_OFFERS: TraderOffer[] = [
  ...
  // Elemental resource rewards (new useful trades)
  { id: 'fire_to_air', elementType: 3, elementAmount: 10000, rewardType: 'rune', rewardAmount: 1, rewardRuneId: 0 }, // Trade Fire for Common Rune
  { id: 'water_to_light', elementType: 2, elementAmount: 12000, rewardType: 'rune', rewardAmount: 1, rewardRuneId: 4 }, // Trade Water for Legendary Rune
  { id: 'earth_to_dark', elementType: 1, elementAmount: 15000, rewardType: 'rune', rewardAmount: 1, rewardRuneId: 5 }, // Trade Earth for Mythic Rune
];
